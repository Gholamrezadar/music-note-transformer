    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-4 sm:p-6 md:p-8 lg:p-24">
      ...
      <div className="w-full max-w-3xl mx-auto space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-muted-foreground">Transform music notes to qwerty format for <a className="text-blue-400" href="https://www.onlinepianist.com/virtual-piano"> virtual-piano</a></p>
        </div>
